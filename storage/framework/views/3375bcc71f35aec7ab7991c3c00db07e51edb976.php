            ...
            <div class="card-body">
              <div class="card-title d-flex align-items-start justify-content-between">
                <div class="avatar flex-shrink-0">
                  <img src="<?php echo e(asset('assets/img/icons/unicons/chart-success.png')); ?>" alt="chart success"
                       class="rounded">
                </div>
                <div class="dropdown">
              ...
              <h3 class="card-title mb-2"><?php echo e($totalOrders); ?></h3>
        ...
        <div class="col-lg-6 col-md-12 col-6 mb-4">
          <div class="card">
            <div class="card-body">
              <div class="card-title d-flex align-items-start justify-content-between">
                <div class="avatar flex-shrink-0">
                  <img src="<?php echo e(asset('assets/img/icons/unicons/wallet-info.png')); ?>" alt="Credit Card" class="rounded">
                </div>
                <div class="dropdown">
              ...
              <span>Sales</span>
              <h3 class="card-title text-nowrap mb-1">$<?php echo e($totalRevenue); ?></h3>
        ...
        <div class="col-6 mb-4">
          <div class="card">
            <div class="card-body">
              <div class="card-title d-flex align-items-start justify-content-between">
                <div class="avatar flex-shrink-0">
                  <img src="<?php echo e(asset('assets/img/icons/unicons/account.png')); ?>" alt="Credit Card"
                       class="w-px-40 h-px-40">
                </div>
                <div class="dropdown">
              ...
              <h3 class="card-title text-nowrap mb-2"><?php echo e($totalUsers); ?></h3>
        ...
        <div class="col-6 mb-4">
          <div class="card">
            <div class="card-body">
              ...
              <h3 class="card-title mb-2"><?php echo e($totalProducts); ?></h3>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          <ul class="p-0 m-0">
            <li class="d-flex mb-4 pb-1">
              <div class="avatar flex-shrink-0 me-3">
                <img src="<?php echo e(asset('assets/img/icons/unicons/account.png')); ?>" alt="User" class="rounded">
              </div>
              <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div class="me-2">
            ...
            <li class="d-flex mb-4 pb-1">
              <div class="avatar flex-shrink-0 me-3">
                <img src="<?php echo e(asset('assets/img/icons/unicons/cc-success.png')); ?>" alt="User" class="rounded">
              </div>
              <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div class="me-2">
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\selim\OneDrive\Bureau\ZeroWaste Laravel\resources\views/content/dashboard/dashboards-analytics.blade.php ENDPATH**/ ?>